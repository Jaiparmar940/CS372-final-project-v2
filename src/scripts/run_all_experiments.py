...
def main():
    ...
    plot_learning_curves_comparison(agents, plot_dir="data/plots")
    ...
    agent_demos = [
        ("DQN (Adam)", "dqn", "models/dqn/dqn_adam_best.pt"),
        ("DQN (RMSprop)", "dqn", "models/dqn/dqn_rmsprop_best.pt"),
        ("A2C (Adam)", "a2c", "models/a2c/a2c_best.pt"),
    ]
